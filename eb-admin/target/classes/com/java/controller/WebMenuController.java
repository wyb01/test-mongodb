...
public class WebMenuController {
    ...
    public @ResponseBody Map<String,Object> getHxMenus(Integer page,Integer rows){
    ...
    public @ResponseBody boolean addWebMenu(String title,String url){
    ...
    public @ResponseBody boolean updateWebMenu(String title,String url,Long id){
        //1、校验title、url是否满足格式要求
        if(title==null || url==null){
            return false;
        }
    ...
    public @ResponseBody boolean deleteWebMenu(String idStr){
        //idStr="1   ,   2    ,   3   ,"
